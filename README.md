...
- **Escrow docs** (`docs/escrow`): Access-control model, threat scenarios, and reviewer notes.
...
- Role enforcement is implemented in `contracts/escrow/src/lib.rs`.
- Dedicated tests for role checks and failure paths:
